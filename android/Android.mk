...
LOCAL_SRC_FILES := applications/tgoggin.cpp applications/gameloop.cpp $(wildcard $(LOCAL_PATH)/engine/*.cpp) $(wildcard $(LOCAL_PATH)/exception/*.cpp) $(wildcard $(LOCAL_PATH)/graphics/*.cpp) $(wildcard $(LOCAL_PATH)/io/*.cpp) $(wildcard $(LOCAL_PATH)/sprite/*.cpp)
