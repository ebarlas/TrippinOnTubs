...
LOCAL_SRC_FILES := $(wildcard $(LOCAL_PATH)/engine/*.cpp) $(wildcard $(LOCAL_PATH)/game/*.cpp) $(wildcard $(LOCAL_PATH)/lock/*.cpp) $(wildcard $(LOCAL_PATH)/sprite/*.cpp) $(wildcard $(LOCAL_PATH)/net/*.cpp)
