...
namespace trippin {
    ...
    struct Rect {
        ...
        static Rect<T> intersect(const Rect<T> &a, const Rect<T> &b);
        Vector<T> corner() const;
        Rect<T> intersect(const Rect<T> &b) const;
        bool leftAlignedWith(const Rect<T> &other) const;
        bool rightAlignedWith(const Rect<T> &other) const;
        bool topAlignedWith(const Rect<T> &other) const;
        bool bottomAlignedWith(const Rect<T> &other) const;
        operator bool() const;
        static Sides collision(const Rect<T> &a, const Rect<T> &b);
        Sides collision(const Rect<T> &b) const;
    };
    ...
    template<class T>
    Rect<T> Rect<T>::intersect(const Rect<T> &a, const Rect<T> &b) {
        T x{}, y{}, w{}, h{};
    ...
    template<class T>
    Vector<T> Rect<T>::corner() const {
        return {x, y};
    }

    template<class T>
    Rect<T> Rect<T>::intersect(const Rect<T> &b) const {
        return intersect(*this, b);
    }

    template<class T>
    bool Rect<T>::leftAlignedWith(const Rect<T> &other) const {
        return x == other.x;
    }

    template<class T>
    bool Rect<T>::rightAlignedWith(const Rect<T> &other) const {
        return x + w == other.x + other.w;
    }

    template<class T>
    bool Rect<T>::topAlignedWith(const Rect<T> &other) const {
        return y == other.y;
    }

    template<class T>
    bool Rect<T>::bottomAlignedWith(const Rect<T> &other) const {
    ...
    template<class T>
    Sides Rect<T>::collision(const Rect<T> &a, const Rect<T> &b) {
        Sides sides{};
    ...
    template<class T>
    Sides Rect<T>::collision(const Rect<T> &b) const {
